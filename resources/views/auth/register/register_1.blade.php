                    ...
                    <div class="tab-pane active" id="tab1">
                        <section class="form-group">
                            ...
                            <article>
                                <section class="row">
                                    <div class="form-group col-sm-6 label-floating {{ $errors->has('client.name') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="client[name]" value="{{ $data['client']['name'] or old('client.name') }}">
                                    ...
                                    <div class="form-group col-sm-6 label-floating {{ $errors->has('client.identity_document') ? ' has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="client[identity_document]"
                                                   value="{{ $data['client']['identity_document'] or old('client.identity_document') }}" id="identity_document">
                                ...
                                <section class="row">
                                    <div class="col-sm-12">
                                        <phones-component :editing="{{ json_encode(old('phones', [])) or json_encode($data['phones'])}}"></phones-component>
                                    </div>
                                </section>
                                ...
                                <section class="row">
                                    <section class="form-group col-sm-12 {{ $errors->has('user.email') ? ' has-error' : '' }} label-floating">
                                        <div class="input-group">
                                            ...
                                            <input type="email" class="form-control" name="user[email]" value="{{ $data['user']['email'] or old('user.email') }}">
                                    ...
                                    <div class="form-group col-sm-6  label-floating {{ $errors->has('password') ? 'has-error' : '' }}">
                                        <div class="input-group">
                                            ...
                                            <input type="password" class="form-control" name="user[password]"
                                                   value="{{ $data['user']['password'] or old('password') }}">
